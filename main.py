...
def startMessage():
    ...
    try:
        if start != code:
            ...
            print(Fore.BLUE + '''
1. Run Run the telebot.py script 
2. Go to telegram
3. Join https://t.me/codebytexbot
4. Send #GetCode In Bot
5. You Will Get Code For Free
6. Next time come with code and use this tool
''' + Fore.WHITE)
            try:
